...
// ListCommandQueue operation middleware
func (siw *ServerInterfaceWrapper) ListCommandQueue(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	var handler = func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ListCommandQueue(w, r, host)
	}
